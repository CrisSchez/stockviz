...
dfProducts=pd.read_csv(os.getcwd()+'/amp_retail_0/products.csv',header=0)
...
prod_data = spark.read.csv(
    os.getcwd()+"/amp_retail_0/products.csv",
    header=True,
    schema=schemaProd,
    sep=',',
    nullValue='NA'
...
dfCustomers=pd.read_csv(os.getcwd()+'/amp_retail_0/customers.csv',header=0)
...
customer_data = spark.read.csv(
    os.getcwd()+"/amp_retail_0/customers.csv",
    header=True,
    schema=schemaCust,
    sep=',',
    nullValue='NA'
...
dfTransactions=pd.read_csv(os.getcwd()+'/amp_retail_0/transactions.csv',header=0)
...
transaction_data = spark.read.csv(
    os.getcwd()+"/amp_retail_0/transactions.csv",
    header=True,
    schema=schemaTran,
    sep=',',
    nullValue='NA'
